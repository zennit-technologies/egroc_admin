...
define('DOMAIN_URL', 'https://grocery.zennit.in/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'Nc0t9HhXFopln5qtzIyVc67URXAJqWPo9vvvT5KSabadUopZBhAqdfspj2u5nfbJ'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_user = "zennit_grocery";  // Change as required
    private $db_pass = "ervj2019@";  // Change as required
    private $db_name = "zennit_grocery";    // Change as required
