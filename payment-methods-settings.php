                            ...
                            <div class="col-md-4">
                                <form method="post" id="payment_method_settings_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ssl_commerece_store_id" value="<?= (isset($data['ssl_commerece_store_id'])) ? $data['ssl_commerece_store_id'] : '' ?>" placeholder="SSL Commerece Store ID" />
                                    </div>
                                    <div class="form-group">
                                        <label for="ssl_commerece_secret_key">Store Password (API/Secret Key)</label>
                                        <input type="text" class="form-control" name="ssl_commerece_secret_key" value="<?= (isset($data['ssl_commerece_secret_key'])) ? $data['ssl_commerece_secret_key'] : '' ?>" placeholder="SSL Commerece Secret Key" />
                                    </div>
                                    <br>
                                    <div class="form-group">
