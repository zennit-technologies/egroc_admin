            ...
            <?php if ($permissions['customers']['read'] == 1) { ?>
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-hover" id="user_table" data-toggle="table" data-url="api-firebase/get-bootstrap-table-data.php?table=users" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-filter-show-clear="true" data-query-params="queryParams_1" data-sort-name="u.id" data-sort-order="desc" data-show-export="true" data-export-types='["txt","excel"]' data-export-options='{"fileName": "customers-list-<?= date('d-m-Y') ?>","ignoreColumn": ["operate"] }'>
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="pincode" data-sortable="true" data-visible="true">Pincode</th>
    ...
    $(document).on('click', '.change-status', function() {
        if (confirm('Are you sure? Want to change status.')) {
            ...
            $.ajax({
                ...
                type: "get",
                data: 'id=' + id + '&status=' + status + '&update_user_status=1',
                success: function(result) {
                    ...
                    if (result == 2) {
                        alert('You have no permission to update users');
                    }
                }
            });
        }
