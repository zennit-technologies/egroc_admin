                                    ...
                                    ?>
                                        <div class="card col-md-3">
                                            <div class="card-body">
                                                ...
                                                <a href="#" title='update' id="submit_btn" class="btn btn-primary col-sm-12 col-md-12 update_order_item_status ">Update</a>
...
<script>
    ...
    // $(function() {
    //     var latitude = $('#map_locate').data("latitude");
    //     var longitude = $('#map_locate').data("longitude");
    ...
    //             var latitude = $('#map_locate').data("latitude");
    //             var longitude = $('#map_locate').data("longitude");
    //             var html = '<a class="btn btn-primary" data-fancybox="" data-options="{&quot;iframe&quot; : {&quot;css&quot; : {&quot;width&quot; : &quot;80%&quot;, &quot;height&quot; : &quot;80%&quot;}}}" href="https://www.google.com/maps/search/?api=1&amp;query='+latitude+','+longitude+'&hl=es;z=14&amp;output=embed">Locate</a>';
    //                             $('#user-review-images').html(html);

    //             // $('#review-image-title').data('options', "{&quot;iframe&quot; : {&quot;css&quot; : {&quot;width&quot; : &quot;80%&quot;, &quot;height&quot; : &quot;80%&quot;}}}");
    //             // $('#map_locate').attr('href', 'https://www.google.com/maps/search/?api=1&amp;query='+latitude+','+longitude+'&hl=es;z=14&amp;output=embed');
