...
if (isset($_POST['btnEdit'])) {
    ...
    if (!empty($name) && !empty($category_id) &&  !empty($serve_for) && !empty($description) && empty($error['cancelable']) && empty($error)) {
        ...
        if (!empty($image)) {
            ...
            $sql_query = "UPDATE products SET name = '$name' ,tax_id = '$tax_id' ,seller_id = '$seller_id',slug = '$slug' , subcategory_id = '$subcategory_id', image = '$upload_image', description = '$description', indicator = '$indicator', manufacturer = '$manufacturer', made_in = '$made_in', return_status = '$return_status', return_days = '$return_days', cancelable_status = '$cancelable_status', till_status = '$till_status',`status` = $pr_status,`is_approved` = $is_approved,`cod_allowed` = $is_cod_allowed,`total_allowed_quantity`= $total_allowed_quantity WHERE id = $ID";
            $db->sql($sql_query);
        } else if ($pincode_type != "") {
            $sql_query = "UPDATE products SET name = '$name' ,type= '$pincode_type',pincodes = '$pincode_ids',tax_id = '$tax_id' ,seller_id = '$seller_id' ,slug = '$slug' ,category_id = '$category_id' ,subcategory_id = '$subcategory_id' ,description = '$description', indicator = '$indicator', manufacturer = '$manufacturer', made_in = '$made_in', return_status = '$return_status',return_days = '$return_days', cancelable_status = '$cancelable_status', till_status = '$till_status' ,`status` = $pr_status,`is_approved` = $is_approved,`cod_allowed` = $is_cod_allowed,`total_allowed_quantity`= $total_allowed_quantity WHERE id = $ID";
            $db->sql($sql_query);
        } else {
            $sql_query = "UPDATE products SET name = '$name' ,tax_id = '$tax_id' ,seller_id = '$seller_id',slug = '$slug' ,category_id = '$category_id' ,subcategory_id = '$subcategory_id' ,description = '$description', indicator = '$indicator', manufacturer = '$manufacturer', made_in = '$made_in', return_status = '$return_status',return_days = '$return_days', cancelable_status = '$cancelable_status', till_status = '$till_status' ,`status` = $pr_status,`is_approved` = $is_approved,`cod_allowed` = $is_cod_allowed,`total_allowed_quantity`= $total_allowed_quantity WHERE id = $ID";
            $db->sql($sql_query);
        }
        // echo $sql_query;
        $res = $db->getResult();
